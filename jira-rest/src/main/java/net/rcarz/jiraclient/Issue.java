...
public class Issue extends Resource {
    ...
    public static final class FluentCreate {
      ...
      System.out.println("req -> " + req);
            System.out.println("uri -> " + getRestUri(null));
            try {
   ...
   */
    ...
    @Override public String toString() {
        ...
        sb.append(", fixVersions=").append(fixVersions);
        sb.append(", issueLinks=").append(issueLinks);
        ...
        sb.append(", timeTracking=").append(timeTracking);
        sb.append(", versions=").append(versions);
        sb.append(", votes=").append(votes);
        sb.append(", watches=").append(watches);
        sb.append(", workLogs=").append(workLogs);
        sb.append(", timeEstimate=").append(timeEstimate);
